...
pipenv run python run.py --model v1 --trials 100 --description "complete-set-free"
zip -r complete-set-free.zip data

# everything with validation and test fixed images
pipenv run python data.py --prefix fixed
pipenv run python run.py --model v1 --trials 100 --description "complete-set-fixed"
...
# c3-c4 fixed images
pipenv run python data.py --prefix fixed
pipenv run python run.py --model v2 --trials 100 --description "c3-c4-fixed"
